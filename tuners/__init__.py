...
from .molora import iTransformerMoLora, TransformerMoLora, InformerMoLora, AutoformerMoLora, iTransformerMoLoraT
...
TUNER_DICT = {
    ...
    'iTransformerMoLoraT': iTransformerMoLoraT
}
...
PARAM_TARGET_DICT = {
    ...
    'iTransformerMoLoraT': {'param_target': 'lora_score', 'param_other': 'lora'},
