def print_args(args):
    ...
    print("\033[1m" + "Save" + "\033[0m")
    print(f'  {"Checkpoints:":<20}{args.checkpoints:<20}')
    print(f'  {"Results:":<20}{args.results:<20}')
    print(f'  {"Test Results:":<20}{args.test_results:<20}')
    print(f'  {"Log Path:":<20}{args.log_path:<20}')
    print(f'  {"Output Predictions and GroundTruth:":<20}{args.output_pred:<20}')
    print(f'  {"Output Visualizations:":<20}{args.output_vis:<20}')
    print()
    ...
    if 'forecast' in args.task_name:
        ...
        print(f'  {"Label Pred Len:":<20}{args.label_pred_len:<20}')
    ...
    print("\033[1m" + "FreDF Setting" + "\033[0m")
    print(f'  {"Alpha:":<20}{args.auxi_lambda:<20}{"1 - Alpha:":<20}{args.rec_lambda:<20}')
    print(f'  {"Auxi Loss:":<20}{args.auxi_loss:<20}{"Auxi Mode:":<20}{args.auxi_mode:<20}')
    print(f'  {"Auxi Type:":<20}{args.auxi_type:<20}{"Module First:":<20}{args.module_first:<20}')
    print(f'  {"Degree of Polynominal:":<20}{args.leg_degree:<20}')
    print()
