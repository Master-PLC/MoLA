...
class Model(nn.Module):
    ...
    def long_forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec, **kwargs):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None, **kwargs):
        if 'long_term_forecast' in self.task_name:
            dec_out = self.long_forecast(x_enc, x_mark_enc, x_dec, x_mark_dec, **kwargs)
